// MediaCloud Service - Handles news aggregation and gun violence media coverage
...
export const searchGunViolenceNews = async (state = null, maxArticles = 25, daysBack = 180) => {
    try {
...
export const getStateNews = async (state, maxArticles = 15) => {
    if (!state) {
        return {
            success: false,
